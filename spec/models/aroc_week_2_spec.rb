...
# ----------------------
  ...
  it '10. sorts the orders from most expensive to least expensive' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders = Order.order(amount: :desc) #Order and Order.all both select "all" the records from the orders table
    # ------------------------------------------------------------
  ...
  it '11. sorts the orders from least expensive to most expensive' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders = Order.all.order(amount: :asc) #Order and Order.all both select "all" the records from the orders table
    # ------------------------------------------------------------
