...
# ----------------------
  ...
  it '10. sorts the orders from most expensive to least expensive' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders = Order.order(:amount).reverse_order #¯\_(ツ)_/¯
    # ------------------------------------------------------------
  ...
  it '12. should return all items except items 2, 5 and 6' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    ids_not_included = items_not_included.map {|x| x.id}
    items = Item.where.not(:id => ids_not_included)
    # ------------------------------------------------------------
  ...
  it '15. gets all item names associated with all orders' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    names = Order.joins(order_items: :item).pluck(:name)
    # ------------------------------------------------------------
