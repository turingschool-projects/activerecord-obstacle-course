...
# ----------------------
  ...
  it '22. calculates the total sales for all but one user' do
    ...
    # -----------------------------------------------------------
    # sql = SELECT SUM(amount) FROM orders WHERE NOT user_id = 3
    # ------------------ Using ActiveRecord ---------------------
 ...
 it '23. returns all orders which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    #sql = SELECT * FROM orders INNER JOIN order_items ON orders.id = order_items.order_id WHERE order_items.item_id = 2;
  ...
  it '24. returns all orders for user 2 which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    orders = Order.joins(:order_items).where('orders.user_id = 2 AND order_items.item_id = 2')
    # -----------------------------------------------------------
