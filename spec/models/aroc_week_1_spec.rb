...
# ----------------------
  ...
  it '2. finds order id of smallest order' do
    ...
    # ----------------------- Using SQL --------------------------
#     SELECT orders.id FROM Orders order by Amount limit 1;
    # ------------------------------------------------------------
  ...
  it '3. finds order id of largest order' do
    ...
    # ----------------------- Using SQL --------------------------
    # rails dbconsole
    # SELECT orders.id FROM Orders order by Amount desc limit 1;
    # ------------------------------------------------------------
  ...
  it '7. finds orders with an amount between 700 and 1000' do
    ...
    # ------------------ Using ActiveRecord ----------------------
     # orders_between_700_and_1000 = Order.where("amount >= ?", 700 )
     ## IS THIS A FLUKE THAT THIS PASSES?
    # ------------------------------------------------------------
